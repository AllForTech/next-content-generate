...
export default function Dashboard() {
  ...
  const displayContent = () => {
    if (isDashboardLoading) {
      ...
      return (
        <ScrollArea className={cn('h-[62dvh] w-full')}>
    ...
    if (contents.length !== 0) {
      ...
      return (
        <ScrollArea className={cn('h-full flex-1 rounded-md px-3')}>
          <div className="container-full grid grid-cols-1 gap-6 overflow-hidden md:grid-cols-2 lg:grid-cols-3">
