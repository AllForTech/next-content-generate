...
import logo from '@/assets/freepik__adjust__green.png'
    ...
    return (
        <header className={`w-full h-[40px] relative center p-[3px]`}>
            ...
            <div className={`center container-fit !p-0 !shadow-none gap-[10px] lg:gap-[20px]`}>
                ...
                <div className={`items-center justify-center min-[360px]:flex hidden w-fit h-fit rounded-full !shadow-none`}>
                    <div className={`size-[30px] button-dark rounded-full`}>
