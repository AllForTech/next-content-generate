...
const Header = ({ children }) => {
    ...
    return (
        <header className={`w-full h-[40px] center p-[3px]`}>
            <div className={`container-fit center !shadow-none`}>
            ...
            <div className={`center container-fit !shadow-none gap-[20px]`}>
                <button
                    onClick={toggleTheme}
                    type={'button'}
                    className={cn(`size-[28px] button-dark center rounded-full`)}>
                    {isDarkMode ? (
                        <MoonIcon size={16}/>
                    ) : (
                        <SunIcon size={16}/>
                ...
                <div className={`center w-fit h-fit rounded-full !shadow-none`}>
                    <div className={`size-[33px] button-dark rounded-full`}>
