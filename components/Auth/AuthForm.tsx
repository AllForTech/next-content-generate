...
const AuthForm = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-sm rounded-md p-3 py-4 shadow-lg shadow-neutral-400">
      <div className="text-center">
        ...
        <h2 className="mt-6 text-2xl font-bold text-black">Welcome to ThinkInk</h2>
        <p className="mt-2 text-sm text-gray-600">AI-powered blogging, made easy</p>
      </div>
      <form className="mt-8 space-y-6">
        <button
          ...
          type="button"
          disabled={loading}
          className="h-[40px] w-full rounded-md border-none bg-zinc-900 text-sm font-medium text-white transition-all outline-none hover:bg-zinc-800"
        >
