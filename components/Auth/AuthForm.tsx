...
const AuthForm = () => {
  ...
  return (
    <div
      className={cn(
        `w-[300px] md:w-[400px] pt-[10px] z-10 h-[200px] border-white/50 border-1 flex-col pb-[20px] transition-400 backdrop-blur-lg rounded-md bg-white/10 shadow-lg center p-2.5 px-3.5`
      )}
    >
      ...
      <form className={"container-full"}>
        <button
          ...
          disabled={loading}
          className={
            "w-full h-[40px] rounded-sm border-none outline-none text-sm text-white font-regular bg-zinc-900 hover:bg-zinc-700 transition-400"
          }
        >
